...
namespace AutoCheck.Core.Connectors{
    ...
    public class Dmoj: Base{                
        ...
        // public Dmoj(Utils.OS remoteOS, string host, string username, string password, int port, string filePath){  
        ...
        // /// <param name="password">The remote machine's password which one will be used to login.</param>
        // /// <param name="filePath">CSS file path.</param>
        // public Dmoj(Utils.OS remoteOS, string host, string username, string password, string filePath): this(remoteOS, host, username, password, 22, filePath){
        // } 
