...
namespace AutomatedAssignmentValidator.CopyDetectors{
    public class SqlLog: Core.CopyDetectorBase{
        private class File{
        ...
        private float WordsAmountWeight {get; set;}
        private float WordCountWeight {get; set;}
        private float LineCountWeight {get; set;}    
