...
namespace AutoCheck.Test.Checkers
{
    ...
    public class SourceCode : Test
    {
        ...
        [Test]
        [TestCase(0, "*.java", "sample1.java")]
        [TestCase(0, "*.java", "sample2.java")]
        ...
        [Test]
        [TestCase(0, "*.java", "sample1.java", "sample1.java")]
        ...
        [Test]
        [TestCase(0, "*.java", "sample1.java", "sample1.java", true)]
        [TestCase(0, "*.java", "sample1.java", "sample2.java", true)]
        [TestCase(0.8f, "*.java", "sample1.java", "sample2.java", true)]
        [TestCase(0.85f, "*.java", "sample1.java", "sample2.java", false)]
        [TestCase(1f, "*.java", "sample1.java", "sample2.java", false)]
