    ...
    {             
        ...
        {              
            ...
            using(var psql = new AutoCheck.Core.Connectors.Postgres("localhost", "AutoCheck-Test-RestoreDB-Ok1", "postgres", "postgres")){
                ...
                var s = new AutoCheck.Core.Script(GetSampleFile("restore_db\\restoredb_ok1.yaml"));   
        ...
        {              
            ...
            using(var psql = new AutoCheck.Core.Connectors.Postgres("localhost", "AutoCheck-Test-RestoreDB-Ok2", "postgres", "postgres")){
                Assert.IsFalse(psql.ExistsDataBase());                
                var s = new AutoCheck.Core.Script(GetSampleFile("restore_db\\restoredb_ok2.yaml"));   
        ...
        {              
            ...
            using(var psql = new AutoCheck.Core.Connectors.Postgres("localhost", "AutoCheck-Test-RestoreDB-Ok31", "postgres", "postgres")){
                Assert.IsFalse(psql.ExistsDataBase()); 
                var s = new AutoCheck.Core.Script(GetSampleFile("restore_db\\restoredb_ok3.1.yaml"));   //TODO: Should use a own file (not resue another test one...)   
            ...
            using(var psql = new AutoCheck.Core.Connectors.Postgres("localhost", "AutoCheck-Test-RestoreDB-Ok32", "postgres", "postgres")){
                Assert.IsFalse(psql.ExistsDataBase());                                
                var s = new AutoCheck.Core.Script(GetSampleFile("restore_db\\restoredb_ok3.2.yaml"));   
        ...
        {              
            ...
            using(var psql = new AutoCheck.Core.Connectors.Postgres("localhost", "AutoCheck-Test-RestoreDB-Ok4", "postgres", "postgres")){
                Assert.IsFalse(psql.ExistsDataBase()); 
                var s = new AutoCheck.Core.Script(GetSampleFile("restore_db\\restoredb_ok4.yaml"));
                Assert.IsTrue(psql.ExistsDataBase());                                
                ...
                s = new AutoCheck.Core.Script(GetSampleFile("restore_db\\restoredb_ok4.yaml"));   
        ...
        {              
            ...
            using(var psql = new AutoCheck.Core.Connectors.Postgres("localhost", "restoredb_ok5-dump1_sql", "postgres", "postgres")){
                Assert.IsFalse(psql.ExistsDataBase());
                var s = new AutoCheck.Core.Script(GetSampleFile("restore_db\\restoredb_ok5.yaml"));                   
        ...
        {  
            ...
            using(var gdrive = new AutoCheck.Core.Connectors.GDrive(_user, _secret)){
                ...
                var s = new AutoCheck.Core.Script(GetSampleFile("upload_gdrive\\uploadgdrive_ok1.yaml"));                   
        ...
        {  
            ...
            using(var gdrive = new AutoCheck.Core.Connectors.GDrive(_user, _secret)){
                ...
                var s = new AutoCheck.Core.Script(GetSampleFile("upload_gdrive\\uploadgdrive_ok2.yaml"));   
                System.Threading.Thread.Sleep(5000);
        ...
        {  
            ...
            using(var gdrive = new AutoCheck.Core.Connectors.GDrive(_user, _secret)){
                ...
                var s = new AutoCheck.Core.Script(GetSampleFile("upload_gdrive\\uploadgdrive_ok3.yaml"));                               
                System.Threading.Thread.Sleep(5000);
