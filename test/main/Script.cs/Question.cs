...
{    
    ...
    { 
        ...
        {                                      
            ...
            ClassicAssert.AreEqual("Running script question_ok1 (v1.0.0.0):\r\n   Question 1 [1 point]:\r\n      Running echo... OK\r\n\r\n   TOTAL SCORE: 10 / 10", log);
        }
        ...
        {              
            ...
            var log = s.Output.ToString();
            ClassicAssert.AreEqual("Running script question_ok2 (v1.0.0.0):\r\n   Question 1 [1 point]:\r\n      Running echo (1/2)... OK\r\n      Running echo (2/2)... OK\r\n\r\n   TOTAL SCORE: 10 / 10", log);
        }
        ...
        {              
            ...
            var log = s.Output.ToString();
            ClassicAssert.AreEqual("Running script question_ok7 (v1.0.0.1):\r\n   Question 1 [1 point]:\r\n      Checking files... OK\r\n      Getting files... OK\r\n\r\n   TOTAL SCORE: 10 / 10", log);
        }
        ...
        {              
            ...
            var log = s.Output.ToString();
            ClassicAssert.AreEqual("Running script question_ok5 (v1.0.0.0):\r\n   Question 1 [2 points]:\r\n      Running echo (1/2)... OK\r\n      Running echo (2/2)... OK\r\n\r\n   Question 2 [1 point]:\r\n      Running echo (1/2)... OK\r\n      Running echo (2/2)... ERROR:\n         -Expected -> Wanted fail!; Found -> This is NOT OK\r\n\r\n   TOTAL SCORE: 6.67 / 10", log);
        }
        ...
        {              
            ...
            var log = s.Output.ToString();
            ClassicAssert.AreEqual("Running script question_ok8 (v1.0.0.1):\r\n   Question 1 [1 point]:\r\n      Checking files... OK\r\n      Getting files... OK\r\n\r\n   Question 2 [1 point]:\r\n      Counting folders... ERROR:\n         -Expected -> -1; Found -> 0\r\n\r\n   TOTAL SCORE: 5 / 10", log);
        } 
        ...
        {                                      
            ...
            var log = s.Output.ToString();
            ClassicAssert.AreEqual("Running script question_ok9 (v1.0.0.0):\r\n   Question 1 [10 points]:\r\n\r\n      Question 1.1 [2 points]:\r\n         Running echo... OK\r\n\r\n      Question 1.2 [5 points]:\r\n         Running echo (1/3)... OK\r\n         Running echo (2/3)... OK\r\n         Running echo (3/3)... OK\r\n\r\n      Question 1.3 [3 points]:\r\n         Running echo... ERROR:\n            -Expected -> Wanted Error!; Found -> Hello\r\n\r\n   TOTAL SCORE: 7 / 10", log);
        }
        ...
        {                                      
            ...
            var log = s.Output.ToString();
            ClassicAssert.AreEqual("Running script question_ok11 (v1.0.0.0):\r\n   Question 1 [2 points]:\r\n\r\n      Question 1.1 [1 point]:\r\n         Running echo... OK\r\n\r\n      Question 1.2 [1 point]:\r\n         Running echo... ERROR:\n            -Expected -> Wanted Error!; Found -> Hello\r\n\r\n   TOTAL SCORE: 5 / 10", log);
        }   
        ...
        {                                      
            ...
            var log = s.Output.ToString();
            ClassicAssert.AreEqual("Running script question_ok13 (v1.0.0.0):\r\n   Question 1 [2 points]:\r\n      Running echo One... OK\r\n\r\n      Question 1.1 [1 point]:\r\n         Running echo Two... ERROR:\n            -Expected -> WANTEDERROR; Found -> Two\r\n\r\n\r\n   Aborting execution!\r\n\r\n   TOTAL SCORE: 0 / 10", log);
        } 
    }
}