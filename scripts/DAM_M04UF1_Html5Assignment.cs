        ...
        public override void Run(){
            ...
            OpenQuestion("Question 1", "Index");
                ...
                OpenQuestion("Question 1.1", "Validating headers", 1);
                    EvalQuestion(index.CheckIfNodesMatchesAmount("//h1", 1, Connector.Operator.MIN));
                    EvalQuestion(index.CheckIfNodesMatchesAmount("//h2", 1, Connector.Operator.MIN));
                CloseQuestion();

                OpenQuestion("Question 1.2", "Validating paragraphs", 1);
                    EvalQuestion(index.CheckIfNodesMatchesAmount("//p", 2, Connector.Operator.MIN));
                    EvalQuestion(index.CheckIfNodesContentMatchesAmount("//p", 1500, Connector.Operator.MIN));
                CloseQuestion();

                OpenQuestion("Question 1.3", "Validating breaklines", 1);
                    EvalQuestion(index.CheckIfNodesMatchesAmount("//p/br", 1, Connector.Operator.MIN));
                CloseQuestion();

                OpenQuestion("Question 1.4", "Validating images", 1);
                    EvalQuestion(index.CheckIfNodesMatchesAmount("//img", 1, Connector.Operator.MIN));
                CloseQuestion();
            CloseQuestion();
            ...
            OpenQuestion("Question 2", "Contacte");
                ...
                OpenQuestion("Question 2.1", "Validating text fields", 1);
                    EvalQuestion(contacte.CheckIfNodesMatchesAmount("//input[@type='text']", 2, Connector.Operator.MIN));
                CloseQuestion();

                OpenQuestion("Question 2.2", "Validating number fields", 1);
                    EvalQuestion(contacte.CheckIfNodesMatchesAmount("//input[@type='number']", 1, Connector.Operator.MIN));
                CloseQuestion();

                OpenQuestion("Question 2.3", "Validating email fields", 1);
                    EvalQuestion(contacte.CheckIfNodesMatchesAmount("//input[@type='email']", 1, Connector.Operator.MIN));
                CloseQuestion();

                OpenQuestion("Question 2.4", "Validating radio buttons", 1);
                    EvalQuestion(contacte.CheckIfNodesMatchesAmount("//input[@type='radio']", 3, Connector.Operator.MIN));
                ...
                OpenQuestion("Question 2.5", "Validating select lists", 1);
                    EvalQuestion(contacte.CheckIfNodesMatchesAmount("//select", 1, Connector.Operator.MIN));
                    EvalQuestion(contacte.CheckIfNodesMatchesAmount("//select/option", 3, Connector.Operator.MIN, true));
                ...
                OpenQuestion("Question 2.6", "Validating checkboxes", 1);
                    EvalQuestion(contacte.CheckIfNodesMatchesAmount("//input[@type='checkbox']", 3, Connector.Operator.MIN, false));
                ...
                OpenQuestion("Question 2.7", "Validating textarea fields", 1);
                    EvalQuestion(contacte.CheckIfNodesMatchesAmount("//textarea", 1, Connector.Operator.MIN));
                CloseQuestion();
                ...
                OpenQuestion("Question 2.10", "Validating table", 1);
                    EvalQuestion(contacte.CheckIfNodesMatchesAmount("//tr[1]/td", 4, Connector.Operator.MIN));
                    EvalQuestion(contacte.CheckIfNodesMatchesAmount("//td[@colspan=3]", 1, Connector.Operator.MIN));
                    EvalQuestion(contacte.CheckIfNodesMatchesAmount("//tr/td[1]/label", 8, Connector.Operator.MIN));
                    EvalQuestion(contacte.CheckIfNodesMatchesAmount("//tr/td[2]/label", 1, Connector.Operator.MIN));
                    EvalQuestion(contacte.CheckIfNodesMatchesAmount("//tr/td[3]/label", 5, Connector.Operator.MIN));
