        ...
        public override void Run(){
            ...
            OpenQuestion("Question 1", "Index");
                ...
                OpenQuestion("Question 1.2", "Validating divs", 1);
                    EvalQuestion(html.CheckIfNodesMatchesAmount("//div", 1, Connector.Operator.MIN));
                CloseQuestion();

                OpenQuestion("Question 1.2", "Validating video", 1);
                    EvalQuestion(html.CheckIfNodesMatchesAmount("//video | //iframe[@src] | //object[@data]", 1, Connector.Operator.MIN));
                CloseQuestion();
            CloseQuestion();
